...
export async function generateMetadata({ params }: CareerDetailProps): Promise<Metadata> {
    ...
    return {
        openGraph: {
            ...
            type: "website",
            url: `https://www.team-one.de/karriere/stelle/${career.slug.current}`
        },
        title: career.title,
            ...
            content: (
                <ul className="flex flex-col gap-4">
                    {benefitsList.map((benefit) => (
                        <li key={benefit.text} className="font-gteratext text-medium flex items-start gap-2 text-black">
            ...
            <main className="gap-vertical-inner relative z-10 flex flex-col">
                ...
                <ContentBlock>
                    <Hero
                        ...
                        eyebrows={eyebrows}
                        backLink={{ label: "Zurück zur Übersicht", href: "/karriere" }}
                    />
                </ContentBlock>
