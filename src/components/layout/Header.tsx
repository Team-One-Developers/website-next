		...
		<header className={"sticky top-0 z-50 bg-header_gradient"}>
			...
			<ContentWrapper>
				...
				<div className="flex items-center justify-between pt-[1.625rem]">
					<Link href="/">
						<div className={twJoin("grid self-center duration-300", burgerNavigationOpened && "burgerNavOpened")}>
							<Image
								src={theme === PAGE_THEME.dark ? "/images/logo/t1d-logo-negativ.svg" : "/images/logo/t1d-logo.svg"}
							...
							<div className="fixed inset-0 z-[60] flex justify-end">
								<button
									...
									style={{
										...
										transition: "backgroundColor 500ms cubic-bezier(0.77, 0, 0.175, 1) 0s !important",
									}}
									onClick={() => {
								...
								<div
									...
									style={{
										transition: "transform 500ms cubic-bezier(0.77, 0, 0.175, 1) 0s",
													...
													return (
														<Link
															className={twJoin(
																...
																pathname === linkObj.link ? "text-primary" : "text-white",
															)}
															key={index}
															href={`${linkObj.link}`}
							...
							return (
								<Link
									className={twJoin(
										...
										pathname === linkObj.link ? "bg-t1-darkGray text-primary" : "bg-primary text-t1-darkGray",
									)}
									key={index}
									href={`${linkObj.link}`}
									style={{
