    ...
    return (
        <Section className="pb-56">
            ...
            <p>
                ...
                vorgenommene Daten-Verarbeitungsvorgänge sowohl im Rahmen unserer Kerntätigkeit als auch für die von uns
                vorgehaltenen Online-Medien.
            </p>

            <h2 className="mt-8">Wer bei uns für die Datenverarbeitung verantwortlich ist</h2>
            <address>
            ...
            <h2 className="mt-8">Datenschutzbeauftragter</h2>
            <address>
                IITR Datenschutz GmbH <br />
                Dr. Sebastian Kraska <br />
                Marienplatz 2, 80331 München
            </address>
            <h2 className="mt-8">Ihre Rechte nach der DSGVO</h2>
            <p>
            ...
            <h2 className="mt-8">Wann löschen wir Ihre Daten?</h2>
            <p>
            ...
            <p className="mt-4">Beim Besuch unserer Webseiten werden zwei Typen von Cookies eingesetzt:</p>
            <ul className="mt-4">
                <li>
            ...
            <h2 className="mt-8">Webhosting</h2>
            <p>
            ...
            <h2 className="mt-8">Kontaktaufnahme</h2>
            <p>
            ...
            <h2 className="mt-8">Der Umgang mit ihren Daten im Bewerbungsverfahren</h2>
            <p>
            ...
            <h2 className="mt-8">Webanalyse und Statistik</h2>
            <article>
            ...
            <h2 className="mt-8">Content-Dienste</h2>
            <article>
            ...
            <h2 className="mt-8">Sicherheitsmaßnahmen</h2>
            <article>
