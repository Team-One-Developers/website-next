    ...
    return (
        <PageLayout>
            <Section className="relative">
                ...
                <DancingFigures className="absolute z-10 mt-20 h-[227px] w-[245px] text-primary xs:left-1/2 xs:-translate-x-1/2 xs:translate-y-[-10%] md:left-3/4 md:top-[42.5%] lg:top-[60%] lg:h-[411px] lg:w-[462px]" />
            </Section>
            <Hero
                className="mt-64"
