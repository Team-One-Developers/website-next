                        ...
                        <div className="flex w-full px-4 lg:w-1/2">
                            <div className="w-full">
                                <form className="flex flex-wrap items-center justify-center gap-2 xl:justify-end">
                                    ...
                                    <Button
                                        className="h-[52px] w-full items-center md:w-full xl:w-fit"
                                        color="secondary"
                                    >
                                        Subscribe
                                    </Button>
                ...
                <div className="flex justify-between">
                    ...
                    <div className="w-full px-4 md:w-1/2 lg:w-1/4 xl:w-fit">
                        <div className="mb-10 w-full">
                            ...
                            <Link href="/" className="mb-8 flex items-center text-foreground hover:text-foreground">
