        ...
        <PageLayout>
            <Section>
                ...
                <Typography as="p" variant="paragraph" className="text-white">
                    ...
                    nachweisen, dass zwingende schutzwürdige Gründe an der Datenverarbeitung Ihre Interessen und Rechte
                    überwiegen.
                    <br />
                    <strong>
                ...
                <Typography as="ul" variant="paragraph" className="legalUL mt-4 text-white">
                    <li className="legalULLIPadded">
                        ...
                        <Typography as="ul" variant="paragraph" className="legalUL text-white">
                            <li className="legalULLIPadded">
                ...
                <Typography as="p" variant="paragraph" className="mt-4 text-white">
                    ...
                    vertraglichen Beziehungen (bis zu vier Jahren) erforderlich machen oder die Daten zum Schutz der
                    Rechte einer anderen natürlichen oder juristischen Person gebraucht werden, löschen wir (den Teil)
                    Ihre(r) Daten erst nach Ablauf dieser Fristen. Bis zum Ablauf dieser Fristen beschränken wir die
                    Verarbeitung dieser Daten jedoch auf diese Zwecke (Erfüllung der Aufbewahrungspflichten).
                </Typography>
                <Typography as="h2" variant="h3" className="mt-8">
                    Cookies
                </Typography>
                <Typography as="p" variant="paragraph" className="text-white">
                    ...
                    einer Reihe von Zahlen und Buchstaben, die auf dem von Ihnen genutzten Endgerät abgelegt und
                    gespeichert werden. Cookies dienen vorrangig dazu, Informationen zwischen dem von Ihnen genutzten
                ...
                <Typography as="ul" variant="paragraph" className="legalUL mt-4 text-white">
                    <li className="legalULLIPadded">
                        ...
                        zuordnen lassen. Die Session-Cookies werden gelöscht, wenn Sie sich ausloggen oder Ihren Browser
                        schließen.
                    </li>
                    <li className="legalULLIPadded">
                        <strong>Permanente Cookies:</strong> Permanente Cookies bleiben auch nach dem Schließen des
                        Browsers gespeichert. Dadurch erkennt unsere Webseite Ihren Rechner wieder, wenn Sie auf unsere
                        Webseite zurückkehren. In diesen Cookies werden beispielsweise Informationen zu
                        Spracheinstellungen oder Log-In-Informationen gespeichert. Außerdem kann mit diesen Cookies Ihr
                        Surfverhalten dokumentiert und gespeichert werden. Diese Daten können zu Statistik-, Marketing-
                ...
                <Typography as="ul" variant="paragraph" className="legalUL mt-4 text-white">
                    ...
                    <li className="legalULLIPadded">
                        <strong>Statistik-, Marketing- und Personalisierungs-Cookies:</strong> Dies sind Cookies, die
                        für Analysezwecke oder die Reichweitenmessung eingesetzt werden. Über solche
                        &quot;Tracking&quot;-Cookies können insbesondere Informationen zu eingegebenen Suchbegriffen
                        oder die Häufigkeit von Seitenaufrufen gespeichert sein. Daneben kann aber auch das
                        Surfverhalten eines einzelnen Nutzers (z. B. Betrachten bestimmter Inhalte, Nutzen von
                        Funktionen etc.) in einem Nutzerprofil gespeichert werden. Solche Profile werden genutzt, um
                        Nutzern Inhalte anzuzeigen, die deren potentiellen Interessen entsprechen. Soweit wir Dienste
                        nutzen, über die Cookies zu Statistik-, Marketing- und Personalisierungs-Zwecken auf Ihrem
                        Endgerät gespeichert werden, informieren wir Sie hierzu gesondert in den nachfolgenden
                ...
                <Typography as="ul" variant="paragraph" className="legalUL mt-4 text-white">
                    ...
                    Verarbeitung Ihrer Daten auf unser berechtigtes Interesse, die Qualität und Benutzerfreundlichkeit
                    unseres Internetauftritts, insbesondere der Inhalte und Funktionen zu verbessern. Sie haben über die
                    Sicherheitseinstellungen Ihres Browsers, dem Einsatz der von uns im Rahmen unseres berechtigten
                    Interesses gesetzten Cookies zu widersprechen. Dort haben Sie die Möglichkeit festzulegen, ob Sie
                    etwa von vornherein keine oder nur auf Nachfrage Cookies akzeptieren oder aber festlegen, dass
                    Cookies nach jedem Schließen Ihres Browsers gelöscht werden. Werden Cookies für unsere Webseite
                ...
                <Typography as="ul" variant="paragraph" className="legalUL mt-4 text-white">
                    ...
                    Endgerät setzen zu dürfen, und Sie hierein einwilligen, ist in der von Ihnen erteilten Einwilligung
                    die Rechtsgrundlage zu sehen. Wir informieren Sie im Rahmen der Einwilligung darüber, welche Cookies
                    wir im Einzelnen setzen. Sofern Sie diese Einwilligung nicht erteilen, setzen sich lediglich die
                    sogenannten technisch notwendigen Cookies, die für den ordnungsgemäßen Betrieb unserer
                    Internetseiten sowie deren Darstellung in Ihrem Browser erforderlich sind. Sofern Sie in das Setzen
                    von Cookies eingewilligt haben, haben die jederzeitige Möglichkeit, uns gegenüber der erteilten
                ...
                <Typography as="p" variant="paragraph" className="text-white">
                    ...
                    Ihre IP-Adresse, die der Anbieter benötigt, um unser Online-Angebot an den von Ihnen genutzten
                ...
                <Typography as="p" variant="paragraph" className="text-white">
                    ...
                    E-Mail-Adresse zur Verfügung stellen oder weitere Angaben zur Ihrer Person oder Ihrem Anliegen
                ...
                <Typography as="p" variant="paragraph" className="text-white">
                    ...
                    E-Mail und Telefonnummer, Beruflicher Werdegang inklusive Schulen, Ausbildung, Studium. Sofern Sie
                    die Daten per E-Mail oder über ein Kontaktformular unseres Online-Auftritts senden, erfolgt die
                    Verarbeitung auf elektronischem Wege. Bei einer Übersendung Ihrer Bewerbung über das Kontaktformular
                    ist die Übertragung Ihrer Daten nach dem Stand der Technik verschlüsselt. Sofern Sie Ihre Daten per
                    E-Mail übersenden, weisen wir daraufhin, dass die Übertragung in der Regel unverschlüsselt erfolgt.
                    Kommt es im Anschluss des Bewerbungsverfahrens zum Abschluss eines Arbeitsvertrages, speichern wir
                ...
                <Typography as="p" variant="paragraph" className="mt-4 text-white">
                    ...
                    weitere Speicherung Ihrer Daten zum Zwecke der Beweisführung erforderlich ist, etwa in einem
                    Verfahren nach dem Allgemeinen Gleichbehandlungsgesetz (AGG). Das Bewerbungsverfahren gilt mit der
                    Absendung der Absage an Sie als abgeschlossen.
                </Typography>
                <Typography as="h2" variant="h3" className="mt-8">
                    Webanalyse und Statistik
                </Typography>
                <Typography as="article" variant="paragraph" className="text-white">
                    Um die Besucherströme auf unserer Internetpräsenz zu erfassen und statistisch auszuwerten, setzen
                    wir Webanalyse-Dienste ein. Solche Dienste erfassen unter anderem Daten darüber, von welcher
                    Internetseite Sie auf unsere Internetpräsenz gelangt sind (sogenannte Referrer), auf welche Seiten
                    unserer Internetpräsenz Sie zugegriffen haben, wie lange Sie unsere Seiten besucht und welche
                    Interaktionen Sie dort vorgenommen haben. Daneben werden Daten zu dem von Ihnen verwendeten Browser,
                    Computersystem sowie der Geräteart erhoben. Außerdem können über einen solchen Dienst auch
                    demographische Informationen, wie bspw. das Alter oder das Geschlecht als pseudonyme Werte erfasst
                    werden. Sofern Sie in die Erhebung Ihrer Standortdaten eingewilligt haben, können, je nach Anbieter,
                    auch diese verarbeitet werden.
                    <br />
                    Um diese Daten zu erfassen und zu speichern, setzt der von uns verwendete Webanalyse-Dienst einen
                    Cookie auf das von Ihnen genutzte Endgerät, mit dem auch die Ihnen zugeordnete IP-Adresse erhoben
                    wird. Allerdings wird diese über ein sogenanntes IP-Masking-Verfahren gekürzt, so dass die
                    IP-Adresse nicht mehr Ihrem Besuch auf unserer Internetseite zugeordnet werden kann. Auch im Übrigen
                    werden keine Klardaten wie Namen oder E-Mail-Adressen gespeichert. Weder wir noch der von uns
                    eingesetzte Dienst kennt die Identität der Besucher unserer Internetseiten.
                    <br />
                    Wir möchten Sie darauf hinweisen, dass je nach Sitzland des unten genannten Diensteanbieters die
                    über den Dienst erfassten Daten außerhalb des Raumes der Europäischen Union übertragen und
                ...
                <Typography as="article" variant="paragraph" className="text-white">
                    ...
                    zugeordnete IP-Adresse, da nur so der jeweilige Inhalt in dem von Ihnen verwendeten Browser
                    dargestellt werden kann. Darüber hinaus können die Anbieter dieser Dienste weitere Cookies auf Ihr
                    Endgerät setzen, über die Informationen über Ihr Nutzungsverhalten, Ihre Interessen, das von Ihnen
                    verwendete Gerät und den verwendeten Browser sowie Zeitpunkt und Dauer Ihrer Sitzung erhoben werden.
                    Diese Daten verwenden die Anbieter regelmäßig für Analyse-, Statistik- und Marketingzwecke. Zudem
                    können diese Informationen können auch mit Informationen aus anderen Quellen verbunden werden. Dies
                    gilt insbesondere dann, wenn Sie selbst einen Account bei dem Dienstanbieter unterhalten und zum
                    ...
                    nachfolgend näher benannten Daten auf Server außerhalb des Raumes der Europäischen Union übertragen
                ...
                <Typography as="article" variant="paragraph" className="text-white">
                    ...
                    Technik, um die Vorschriften der Datenschutzgesetze einzuhalten und Ihre Daten gegen zufällige oder
