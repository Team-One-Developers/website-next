...
export const GET = async (request: Request) => {
    ...
    const fontData = await fetch(new URL("../../../fonts/gt-era-display-regular.woff2", import.meta.url)).then((res) =>
        res.arrayBuffer()
    )
    ...
    return new ImageResponse(
        ...
        >
            {/* Blobby, blurred background image */}
            <div
                style={{
                    backgroundImage: `url('data:image/svg+xml;utf8,<svg width="1200" height="630" viewBox="0 0 1200 630" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1190 315Q1200 420 1090 520Q980 620 780 600Q580 580 420 600Q260 620 140 520Q20 420 70 315Q120 210 240 120Q360 30 600 30Q840 30 960 120Q1080 210 1190 315Z" fill='%2346FFAD'/></svg>')`,
            ...
            >
                ...
                >
                    STRATEGISCH, DATENGETRIEBEN, UMSETZUNGSSTARK.
                </p>
                <p style={{ fontSize: 48, marginTop: "16px", color: "white" }}>{blogTitle}</p>
            </div>
        </div>,
        {
            width: 1200,
