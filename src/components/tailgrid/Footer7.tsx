                                ...
                                <form className="flex flex-wrap">
                                    <div className="relative mb-3 mr-5 w-full max-w-[370px]">
                                        <input
                                            ...
                                            className="h-[52px] w-full rounded-md border border-black bg-black/5 pl-14 pr-5 text-black placeholder-dark-8 outline-none focus:border-black/40 focus-visible:shadow-none"
                                        />
                ...
                <div className="-mx-4 flex flex-wrap">
                    <div className="w-full px-4 sm:w-2/3 lg:w-4/12 xl:w-3/12">
                        <div className="mb-10 w-full">
                            ...
                            <div className="-mx-3 flex items-center">
                                <Link href="javascript:void(0)" className="px-3 text-gray-7 hover:text-black">
                    ...
                    <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
                        <div className="mb-10 w-full">
                            ...
                            <Link href="/#" className="mb-8 flex items-center text-gray-7 hover:text-black">
                ...
                <div className="container mx-auto">
                    <div className="-mx-4 flex flex-wrap">
                        <div className="w-full px-4 md:w-1/3 lg:w-1/2">
                            <div className="my-1 flex justify-center md:justify-start text-white">
                                <p className="text-base text-gray-7">&copy; {new Date().getFullYear()} TailGrids</p>
                            </div>
                        </div>
                        <div className="w-full px-4 md:w-1/3 lg:w-1/2">
                            <div className="my-1">
                                <div className="-mx-3 flex flex-wrap items-center justify-center md:justify-end text-white">
...
const BottomNavLink = ({ label, link }: any) => {
    return (
        <Link href={link} className="px-3 text-base text-gray-7 hover:text-black">
            {label}
        </Link>
    )
}
