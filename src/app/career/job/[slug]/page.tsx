...
import { Career, QUERY_ALL_CAREERSResult } from "@/sanity/types"
...
async function getCareerFromParams(params: CareerProps["params"]): Promise<Career | null> {
    const career = await client.fetch(QUERY_SPECIFIC_CAREER, { slug: params.slug })
                ...
                right={
                    <div className="">
                        <article className="max-w-none font-abcdiatype">
                            ...
                            {career.details && <PortableText value={career.details} />}
